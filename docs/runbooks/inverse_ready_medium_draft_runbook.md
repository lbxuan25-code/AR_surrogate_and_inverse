...
- Dataset config: `configs/datasets/drafts/inverse_ready_medium_dataset_draft.json`
- Training config: `configs/surrogate/drafts/inverse_ready_medium_training_draft.json`
- Evaluation config: `configs/surrogate/drafts/inverse_ready_medium_evaluation_draft.json`
...
```bash
python scripts/datasets/build_dataset.py --config configs/datasets/drafts/inverse_ready_medium_dataset_draft.json
python scripts/surrogate/train_surrogate.py --config configs/surrogate/drafts/inverse_ready_medium_training_draft.json
python scripts/surrogate/evaluate_surrogate.py --config configs/surrogate/drafts/inverse_ready_medium_evaluation_draft.json
```
