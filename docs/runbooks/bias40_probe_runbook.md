...
- Dataset config: `configs/datasets/contracts/bias40_probe_dataset_contract.json`
- Training config: `configs/surrogate/contracts/bias40_probe_training_contract.json`
- Evaluation config: `configs/surrogate/contracts/bias40_probe_evaluation_contract.json`
...
```bash
python scripts/datasets/build_dataset.py --config configs/datasets/contracts/bias40_probe_dataset_contract.json
python scripts/surrogate/train_surrogate.py --config configs/surrogate/contracts/bias40_probe_training_contract.json
python scripts/surrogate/evaluate_surrogate.py --config configs/surrogate/contracts/bias40_probe_evaluation_contract.json
```
