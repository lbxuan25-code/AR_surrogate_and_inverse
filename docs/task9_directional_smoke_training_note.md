...
- Dataset config: `configs/datasets/task8_directional_smoke_dataset.json`
- Training config: `configs/surrogate/task9_directional_surrogate_smoke.json`
- Evaluation config: `configs/surrogate/task9_directional_evaluation_smoke.json`
