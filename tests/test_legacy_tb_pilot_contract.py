...
TASK14_TB_PILOT_CONFIG_PATH = Path("configs/datasets/drafts/tb_pilot_dataset_draft.json")
TASK14_TB_PILOT_DOC_PATH = Path("docs/archive/legacy_tb_pilot_contract.md")
...
def test_task14_tb_pilot_dataset_contract_freezes_exact_coordinate_set() -> None:
    ...
    assert config["upstream_pairing_source_contract"] == "configs/datasets/contracts/rmft_anchor_dataset_contract.json"
    assert config["upstream_bias_contract"] == "configs/datasets/contracts/bias40_probe_dataset_contract.json"
    assert config["upstream_transport_contract"] == "docs/contracts/transport_domain_contract.md"
