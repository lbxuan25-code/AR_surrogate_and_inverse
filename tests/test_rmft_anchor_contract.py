...
TASK14_DATASET_CONTRACT_PATH = Path("configs/datasets/contracts/rmft_anchor_dataset_contract.json")
TASK14_AUDIT_DOC_PATH = Path("docs/audits/rmft_projection_audit.md")
...
def test_task14_rmft_anchor_dataset_contract_exists_and_freezes_rmft_roles() -> None:
    ...
    assert config["audit_metadata_output_path"] == "outputs/audits/rmft_projection_audit.json"
...
def test_task14_rmft_audit_doc_records_required_server_side_review_fields() -> None:
    ...
    assert "outputs/audits/rmft_projection_audit.json" in doc
