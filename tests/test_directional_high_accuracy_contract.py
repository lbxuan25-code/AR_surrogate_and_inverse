...
TASK13_RUNBOOK_PATH = Path("docs/runbooks/directional_high_accuracy_runbook.md")
TASK13_LAUNCH_ADDENDUM_PATH = Path("docs/runbooks/directional_high_accuracy_launch_addendum.md")
...
def test_task13_runbook_records_large_scale_accuracy_handoff_requirements() -> None:
    ...
    assert "docs/runbooks/directional_high_accuracy_launch_addendum.md" in runbook
